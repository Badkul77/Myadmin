...
public class HomeActivity extends AppCompatActivity {
    ...
    Button btnuser,btnusermod,btnfeedback,btnsales,btnmodule,btncustomer;
...
btnusermod.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
...
btncustomer.setOnClickListener(new View.OnClickListener() {
    ...
    void init()
    {
        ...
        btnusermod=findViewById(R.id.btnusermodification);
